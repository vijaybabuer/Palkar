...
var app = {
	...
	Core.register('userLoginController',userLoginController, {relPath: "http://www.palpostr.com/", pageHandle: "Palkar"});
	Core.register('messageDisplayController',messageDisplayController,{appname: 'Palkar'});
	Core.register('photoUploadController',photoUploadController, {relPath: "http://www.palpostr.com/", containerDiv: "#photoUploadContainerDiv"});
