...
var app = {
	...
	Core.register('storyEditController',storyEditController,{elemHandle: '#createStory', relPath: "", addPostTextAreaHandle: ".addPostTextArea", storiesDiv: "#storiesDiv", storyJSTemplateName: "template-storyTemplate"});		
	...
	Core.register('userLoginController',userLoginController, {relPath: "", pageHandle: "Palkar"});
	Core.register('messageDisplayController',messageDisplayController,{appname: 'Palkar'});
	Core.register('photoUploadController',photoUploadController, {relPath: "", containerDiv: "#photoUploadContainerDiv"});
	Core.register('albumsController',albumsController,{relPath: ""});
